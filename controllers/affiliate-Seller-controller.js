...
encryptUserString : (req,res)=>{
  const encryptedString = passwordHash.generate(req.body.textToEncrypt);
  return res.send({ encryptedString : encryptedString, message : true})
}
